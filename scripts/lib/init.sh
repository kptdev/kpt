...
source "${KUBE_ROOT}/scripts/lib/util.sh"
source "${KUBE_ROOT}/scripts/lib/logging.sh"

kube::log::install_errexit

source "${KUBE_ROOT}/scripts/lib/version.sh"
source "${KUBE_ROOT}/scripts/lib/golang.sh"
source "${KUBE_ROOT}/scripts/lib/etcd.sh"
