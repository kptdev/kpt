...
func (g GitSuite) TestLock(t *testing.T) {
	...
	wantRefs := map[repository.PackageRevisionKey]string{
		{Repository: repositoryName, Package: "empty", Revision: "v1", Description: "v1"}:   "empty/v1",
		{Repository: repositoryName, Package: "basens", Revision: "v1", Description: "v1"}:  "basens/v1",
		{Repository: repositoryName, Package: "basens", Revision: "v2", Description: "v2"}:  "basens/v2",
		{Repository: repositoryName, Package: "istions", Revision: "v1", Description: "v1"}: "istions/v1",
		{Repository: repositoryName, Package: "istions", Revision: "v2", Description: "v2"}: "istions/v2",

		{Repository: repositoryName, Package: "basens", Revision: g.branch, Description: g.branch}:  g.branch,
		{Repository: repositoryName, Package: "empty", Revision: g.branch, Description: g.branch}:   g.branch,
		{Repository: repositoryName, Package: "istions", Revision: g.branch, Description: g.branch}: g.branch,
	}
