module github.com/GoogleContainerTools/kpt/porch/test
...
require (
	...
	github.com/GoogleContainerTools/kpt/porch/controllers v0.0.0-20220330205144-0b1442857d49 // indirect
