...
type ConditionApplyConfiguration struct {
	...
	Status  *kptfilev1.ConditionStatus `json:"status,omitempty"`
...
func (b *ConditionApplyConfiguration) WithStatus(value kptfilev1.ConditionStatus) *ConditionApplyConfiguration {
	b.Status = &value
	return b
}
