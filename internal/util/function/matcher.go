...
// - Porch function name is <PackageRepository>:<ImageName>:<Version>. e.g. kpt-functions:set-annotations:latest
// - Catalog v2 function name is trimed to only contain <ImageName>:<Version>, and exclude ghcr.io/kptdev/krm-functions-catalog. e.g. set-annotations:latest
