...
func NewRunner(
	...
	imagePullPolicy ImagePullPolicy, setPkgPathAnnotation, displayResourceCount bool) (kio.Filter, error) {
	...
	if strings.Contains(f.Image, "builtins/") {
		switch f.Image {
		case "builtins/gen-pkg-context":
