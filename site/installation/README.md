...
```shell
$ docker run gcr.io/kpt-dev/kpt:v1.0.0-beta.5 version
```
...
```shell
$ docker run gcr.io/kpt-dev/kpt-gcloud:v1.0.0-beta.5 version
```
...
[linux]:
  https://github.com/GoogleContainerTools/kpt/releases/download/v1.0.0-beta.5/kpt_linux_amd64
[darwin]:
  https://github.com/GoogleContainerTools/kpt/releases/download/v1.0.0-beta.5/kpt_darwin_amd64
