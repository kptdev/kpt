...
```shell
$ docker run gcr.io/kpt-dev/kpt:v1.0.0-beta.20 version
```
...
```shell
$ docker run gcr.io/kpt-dev/kpt-gcloud:v1.0.0-beta.20 version
```
...
[linux-arm64]:
  https://github.com/GoogleContainerTools/kpt/releases/download/v1.0.0-beta.20/kpt_linux_arm64
[darwin-amd64]:
  https://github.com/GoogleContainerTools/kpt/releases/download/v1.0.0-beta.20/kpt_darwin_amd64
[darwin-arm64]:
  https://github.com/GoogleContainerTools/kpt/releases/download/v1.0.0-beta.20/kpt_darwin_arm64
