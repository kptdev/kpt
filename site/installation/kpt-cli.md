...
```shell
$ docker run gcr.io/kpt-dev/kpt:v1.0.0-beta.43 version
```
...
```shell
$ docker run gcr.io/kpt-dev/kpt-gcloud:v1.0.0-beta.43 version
```
...
[linux-amd64]:
  https://github.com/GoogleContainerTools/kpt/releases/download/v1.0.0-beta.43/kpt_linux_amd64
[linux-arm64]:
  https://github.com/GoogleContainerTools/kpt/releases/download/v1.0.0-beta.43/kpt_linux_arm64
[darwin-amd64]:
  https://github.com/GoogleContainerTools/kpt/releases/download/v1.0.0-beta.43/kpt_darwin_amd64
[darwin-arm64]:
  https://github.com/GoogleContainerTools/kpt/releases/download/v1.0.0-beta.43/kpt_darwin_arm64
