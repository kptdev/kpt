...
${KPT_FN_RUNTIME} pull ghcr.io/kptdev/krm-functions-catalog-demo/foo:v0.1
${KPT_FN_RUNTIME} tag ghcr.io/kptdev/krm-functions-catalog-demo/foo:v0.1 ghcr.io/kptdev/krm-functions-catalog-demo/bar:v0.1
