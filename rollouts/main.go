...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "23e227a5.kpt.dev",
	...
	if err = (&controllers.RemoteSyncReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "RemoteRootSync")
		os.Exit(1)
	}
	if err = (&controllers.ProgressiveRolloutStrategyReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ProgressiveRolloutStrategy")
		os.Exit(1)
	}
